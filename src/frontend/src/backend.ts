...
export class Backend implements backendInterface {
    ...
    async getDiscordMemberCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getDiscordMemberCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitApplication(arg0: string, arg1: string, arg2: bigint, arg3: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateDiscordMemberCount(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateDiscordMemberCount(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateSocialMediaLinks(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateSocialMediaLinks(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
